...
import Unilogo from './assets/Gemin(1).png';
...
const UnitalkLanding = () => {
  ...
  const testimonials = [
    {
      name: "Amit Sharma",
      role: "1st Year, B.Tech CSE",
      content: "I usually struggle with official notices because they’re in English. The chatbot explained everything to me in Hindi clearly, Super helpful!",
      avatar: "🧑‍💼",
      rating: 4
    },
    {
    ...
    },
    {
      name: "Karan Jha",
      role: "1st Year, B.Tech CSE",
      content: "It feels like the university finally understands students. Quick, clear, and no confusion, this chatbot actually saves time.",
      avatar: "👩‍🏫",
      rating: 3
    }
  ];
 ...
 useEffect(() => {
  ...
  const additionalFeatures = [
    ...
    },
    {
      ...
      description: "Smart responses and document search."
    },
    {
  ...
  const useCases = [
    "24/7 campus helpdesk with no waiting lines",
    "Student-specific info (attendance, grades, scholarships)",
    "Educational support in multiple languages",
    "Customer service across language barriers",
    "Instant answers for fee deadlines & timetables"
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center transform hover:scale-110 transition-transform duration-200">
                <img src={Unilogo}/>
              </div>
              <div>
      ...
      <section ref={heroRef} className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center scroll-animate relative z-10">
            ...
            <h1 className={`relative z-10 text-4xl md:text-6xl lg:text-7xl font-bold ${themeClasses.text} mb-6`}>
                AI that speaks
            <br />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {features.map((feature, index) => (
              <div key={index} className={`${themeClasses.cardBg} backdrop-blur-lg border rounded-2xl p-6 hover:shadow-lg transition-all duration-300 transform hover:scale-105 hover:-translate-y-2`} style={{ animationDelay: `${index * 100}ms` }}>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className={`text-lg ${themeClasses.textSecondary}`}>
              Hear how this chatbot is changing campus life
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-animate">
              <h2 className={`text-3xl md:text-4xl font-bold ${themeClasses.text} mb-6`}>
                Perfect for student interaction
              </h2>
              ...
              <div className="space-y-4">
                {useCases.map((useCase, index) => (
                  <div key={index} className="flex items-center space-x-3" style={{ animationDelay: `${index * 100}ms` }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <button onClick={() => navigate('/Unitalk')} className="text-indigo-400 hover:text-indigo-300">Open Chatbot →</button>
            </div>
          </div>
